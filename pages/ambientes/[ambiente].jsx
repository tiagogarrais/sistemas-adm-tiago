            ...
            <div className="button">
              <li>
                <Link className="link" href={{ pathname: '/ambientes/141' }}>
                  {' '}
                  141 - Vaga deficiente, idosos ate corredor banheiros
                  acessiveis
                </Link>
              </li>
            </div>
            ...
            <div className="button">
              <li>
                <Link className="link" href={{ pathname: '/ambientes/143' }}>
                  {' '}
                  143 - Corredor sala de aula 10, acesso direção, copa, até
                  saída para o bicicletário
                </Link>
              </li>
            </div>
            <div className="button">
            ...
            <div className="button">
              <li>
                <Link className="link" href={{ pathname: '/ambientes/149' }}>
                  {' '}
                  149 - Corredor laboratórios física, biologia, autoclave até
                  casa de gás
                </Link>
              </li>
            </div>
