...
export default function Gtt() {
    ...
    function gravarGrauPrioridadeGtt() {
        ...
        axios.post(
            '/api/brainstorming/enviarGrauPrioridadeGtt',
            {
                    ...
                    <>
                        <div className='cartoes'>
                            <div className='cartao' style={{ textAlign: 'center' }}>
                                ...
                                <p>Definido como {`${ideiasRecebidas.grauPrioridade}`} pela pessoa que cadastrou a ideia.</p>

                                Grau prioridade definido pelo GTT:
                                <select onChange={gravarGrauPrioridadeGtt}>
                                    <option>Escolher uma das opções</option>
                                    <option value="Prioridade 1 - Urgente">Prioridade 1 - Urgente</option>
                                    <option value="Prioridade 2 - Alta">Prioridade 2 - Alta</option>
                                    <option value="Prioridade 3 - Média">Prioridade 3 - Média</option>
                                    <option value="Prioridade 4 - Baixa">Prioridade 4 - Baixa</option>
                                </select>
                            </div>
                        </div>
                    </>
