  ...
  function btnSaveClick() {
    ...
    axios
      ...
      .then(function (res) {
        ...
        <p>Enviaremos e-mail com a confirmação ou negação cinco dias úteis antes da data da viagem.</p> 
        <p>Viagens solicitadas sem o devido planejamento serão respondidas até o próximo dia útil.</p>
