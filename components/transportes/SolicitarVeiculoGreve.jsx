...
export default function SolicitarVeiculoGreve() {
  ...
  function btnSaveClick() {
    ...
    axios
      ...
      .then(function (res) {
        ...
        <p>ESTAMOS EM GREVE!</p> 
        <p>Serão atendidas apenas a demandas  classificadas como SERVIÇOS ESSENCIAIS</p>
        <p>Para verificar quais são estes serviços consultar no e-mail institucional ou diretamente com o comando de greve.</p>
      ...
      .catch(function (error) {
        console.log(error);
        window.alert(
          "Verifique sua conexão e tente novamente! Houve algum erro no envio da solicitação."
        );
        document.getElementById("btnSave").disabled = false;
    ...
    return (
      <div>
        <form onSubmit={btnSaveClick}>
          <div>
            <h2 style={{ backgroundColor: "#b81414", color: "white" }}>
              TÉCNICOS ADMINISTRATIVOS EM GREVE!
            </h2>
            <p style={{ backgroundColor: "red" }}>
              Serão atendidas apenas a demandas classificadas como SERVIÇOS
              ESSENCIAIS
            </p>
            <p style={{ backgroundColor: "red" }}>
              Para verificar quais são estes serviços consultar no e-mail
              institucional ou diretamente com o comando de greve.
            </p>
